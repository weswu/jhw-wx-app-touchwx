    ...
    return Object.assign(g.prototype, h), g.prototype.prepare = function() {
        ...
        t.updateCanvas = function() {
          ...
          t.ctx.draw(), t;
            ...
            t.src = e
            "function" == typeof t.onBeforeImageLoad && t.onBeforeImageLoad(t.ctx, t);
            wx.getImageInfo({
              src: e,
              success: function(e) {
            ...
            switch (toString.call(n[0])) {
              case "[object Object]":
                var a = n[0].quality, s = void 0 === a ? 10 : a;
        ...
        var t = this, e = (t.deviceRadio, t.width), o = t.height, n = t.cut, i = n.x, r = void 0 === i ? 0 : i, c = n.y, a = void 0 === c ? 0 : c, u = n.width, s = void 0 === u ? e : u, l = n.height, d = void 0 === l ? o : l;
